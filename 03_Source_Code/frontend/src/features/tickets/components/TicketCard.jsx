...
export default function TicketCard({ booking, facility, onCheckIn, timeValidation }) {
  ...
  const qrUrl = booking.digital_signature
    ? `${window.location.origin}/bookings/verify/${booking.digital_signature}`
    : adminUrl;
      ...
      >
        ...
        <div className="w-full lg:w-[260px] p-6 md:p-8 bg-gray-50/55 flex flex-col items-center justify-center text-center gap-5 shrink-0">
          ...
          <div className="space-y-1.5 flex flex-col items-center">
            ...
            {booking.digital_signature && (
              <span className="mt-1 flex items-center gap-1 bg-emerald-50 text-emerald-700 px-2 py-0.5 rounded-full border border-emerald-200 text-[8px] font-black uppercase tracking-wider select-none animate-pulse">
